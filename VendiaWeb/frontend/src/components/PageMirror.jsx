  ...
  return (
    <div id="content">
      ...
      <div className="card">
        ...
        <div className="g3">
          {[
            { n: '1', title: 'Lectura',       desc: 'El MirrorController lee todos los registros activos (estado distinto de X) de la BD operacional via JDBC.' },
            { n: '2', title: 'Replicacion',   desc: 'Los registros se escriben en el servidor Mirror con INSERT ON DUPLICATE KEY UPDATE para evitar duplicados.' },
            { n: '3', title: 'Confirmacion',  desc: 'Se retorna un JSON con el conteo de registros leidos y copiados, y el timestamp de la operacion.' },
          ].map(s => (
